...
class MultiDocumentProcessor:
    ...
    def process_documents_from_directory(self, directory_path: str) -> List[DocumentChunk]:
        ...
        for file_path in supported_files:
            try:
                ...
                if text.strip():
                    # Pass the entire file_path object
    ...
    def chunk_document(self, text: str, file_path: Path) -> List[DocumentChunk]:
...
class EnhancedRAGSystem:
    ...
    def process_documents(self, documents_directory: str) -> bool:
        ...
        try:
            ...
            all_chunks = self.document_processor.process_documents_from_directory(documents_directory)
